...
try {
  ...
  for (const name of ['start/index', 'contribute/index', 'development/standalone-quickstart', 'learn/fixture', 'operations/fixture', 'reference/fixture', 'architecture/overview'])
