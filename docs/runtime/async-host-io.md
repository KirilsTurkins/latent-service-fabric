...
[local blobs](local-blobs.md), [S3 blobs](s3-blobs.md), [local secrets](local-secrets.md) and [Vault secrets](vault-secrets.md) install concrete adapters on this substrate; the other providers are tracked
