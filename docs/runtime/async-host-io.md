...
[local blobs](local-blobs.md), [S3 blobs](s3-blobs.md), [local secrets](local-secrets.md), [Vault secrets](vault-secrets.md) and [NATS events](nats-events.md) install concrete adapters on this substrate; the other providers are tracked
