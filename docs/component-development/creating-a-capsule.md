...
Select Rust, C or Go on each complete example below. They implement the same typed
...
[Go authoring](go-authoring.md). Go's runtime also requires explicit clock and
