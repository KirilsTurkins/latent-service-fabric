...
| --- | --- |
| Catalog and contract corrections | [Versioned deployment mutations/pages #67](https://github.com/KirilsTurkins/latent-service-fabric/issues/67), [SDK identity/cancellation parity #65](https://github.com/KirilsTurkins/latent-service-fabric/issues/65) |
