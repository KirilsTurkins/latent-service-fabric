...
pub use http::{
    ...
    RegistryAddressPolicy, RegistryConfig, RegistryCredentials, RegistryDestination,
    RegistryLimits, RegistryNetworkPolicy, RegistryNetworkUsage, RegistryResolution, RegistryUsage,
};
