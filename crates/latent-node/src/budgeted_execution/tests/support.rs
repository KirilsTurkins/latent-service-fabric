...
pub(super) fn request() -> ExecutionRequest {
    ...
    ExecutionRequest {
        activation: ActivationEnvelope {
            activation_id: ActivationId("budgeted-execution-test".to_owned()),
            root_activation_id: ActivationId("budgeted-execution-test".to_owned()),
            ...
            input: b"[]".to_vec(),
            input_media_type: "test".to_owned(),
        },
