...
pub use semantics::{
    compare_packages, compile_host_binding, compile_local_binding, validate_capsule,
    BreakingChangeAllowance, CheckedBinding, CheckedSurface, ComparedPackageIdentity,
