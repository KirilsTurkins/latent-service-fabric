...
pub fn capsule() -> PackageBundle {
    build(
        ...
        vec![function(
            ...
            true,
            vec![
                json!({"name":"which","value_type":"U32","documentation":null}),
                json!({"name":"handle","value_type":"U64","documentation":null}),
            ],
            json!("U64"),
        )],
        true,
...
fn build(
    ...
    if caller {
        ...
        locked.push(WitLockedPackage {
            id: "latent:blob@0.2.0".into(),
            source_path: "wit/blob.wit".into(),
