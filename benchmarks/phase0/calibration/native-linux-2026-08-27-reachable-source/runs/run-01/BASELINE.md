...
**Generated:** Unix epoch 1787820278188 ms
**Raw results:** `/home/slirik/IdeaProjects/latent-service-fabric/benchmarks/phase0/calibration/native-linux-2026-08-27-reachable-source/runs/run-01/raw-results.json`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Process launch to completion | 12 | 50825 | 52445 | 55193 | 55193 | 55193 | 52742.5 |
| Cold activation inside issue-23 harness | 12 | 195 | 208 | 243 | 243 | 243 | 215.6 |
...
| Metric | Microseconds |
|---|---:|
| External process launch to runtime/pool ready | 3859 |
| Rust entry to observed worker/pool readiness | 2660 |
| Capsule validation and component load | 60 |
| Wasmtime engine/backend construction | 147 |
| Component preparation | 49562 |
| Rust entry to retained invocation readiness | 55021 |
...
| Metric | N | Min | P50 | P95 | P99 | Max | Mean |
|---|---:|---:|---:|---:|---:|---:|---:|
| acquire_or_queue_wait_micros | 343 | 1 | 4 | 2511 | 3049 | 3799 | 546.7 |
| activation_resource_reclamation_micros | 343 | 15 | 25 | 59 | 149 | 271 | 32.4 |
| backend_resource_cleanup_micros | 343 | 22 | 36 | 73 | 170 | 282 | 44.2 |
| backend_setup_micros | 343 | 33 | 70 | 123 | 155 | 157 | 73.4 |
| backend_total_micros | 343 | 84 | 1165 | 7298 | 25908 | 26013 | 1778.7 |
| cancellation_elapsed_micros | 10 | 7194 | 7352 | 9534 | 9534 | 9534 | 7583.7 |
| cancellation_overshoot_micros | 10 | 2194 | 2352 | 4534 | 4534 | 4534 | 2583.7 |
| cell_disposition_micros | 343 | 1 | 3 | 7 | 10 | 23 | 3.6 |
| cold_echo_elapsed_micros | 12 | 195 | 208 | 243 | 243 | 243 | 215.6 |
| component_post_return_micros | 343 | 0 | 0 | 3 | 3 | 8 | 0.6 |
| contained_execution_micros | 343 | 61 | 1129 | 7248 | 25832 | 25955 | 1734.5 |
| domain_error_elapsed_micros | 10 | 106 | 185 | 229 | 229 | 229 | 173.1 |
| guest_call_micros | 343 | 26 | 1075 | 7167 | 25760 | 25863 | 1666.0 |
| host_call_micros | 343 | 0 | 1 | 1 | 2 | 4 | 0.6 |
| memory_pressure_elapsed_micros | 10 | 2212 | 2231 | 2352 | 2352 | 2352 | 2275.9 |
| outcome_classification_micros | 343 | 0 | 0 | 1 | 2 | 2 | 0.1 |
| post_invocation_cleanup_micros | 343 | 17 | 29 | 68 | 157 | 280 | 36.7 |
| process_launch_to_completion_real_executable_micros | 12 | 50825 | 52445 | 55193 | 55193 | 55193 | 52742.5 |
| recovery_after_cancellation_elapsed_micros | 10 | 135 | 156 | 250 | 250 | 250 | 168.8 |
| recovery_after_domain_error_elapsed_micros | 10 | 107 | 181 | 266 | 266 | 266 | 183.3 |
| recovery_after_memory_pressure_elapsed_micros | 10 | 153 | 189 | 236 | 236 | 236 | 190.1 |
| recovery_after_timeout_elapsed_micros | 10 | 155 | 159 | 204 | 204 | 204 | 168.8 |
| recovery_after_trap_elapsed_micros | 10 | 106 | 182 | 201 | 201 | 201 | 161.4 |
| retained_first_echo_elapsed_micros | 1 | 254 | 254 | 254 | 254 | 254 | 254.0 |
| reusable_proof_micros | 343 | 0 | 0 | 0 | 1 | 2 | 0.1 |
| throughput_at_capacity_elapsed_micros | 48 | 1177 | 1261 | 1648 | 1856 | 1856 | 1306.9 |
| throughput_bounded_queue_saturation_elapsed_micros | 144 | 1197 | 2450 | 3891 | 5016 | 5482 | 2559.1 |
| timeout_elapsed_micros | 10 | 25192 | 25800 | 26061 | 26061 | 26061 | 25750.5 |
| timeout_overshoot_micros | 10 | 192 | 800 | 1061 | 1061 | 1061 | 750.5 |
| total_invocation_micros | 343 | 99 | 1276 | 7321 | 25964 | 26061 | 2352.5 |
| trap_elapsed_micros | 10 | 117 | 179 | 268 | 268 | 268 | 179.0 |
| warm_echo_elapsed_micros | 40 | 99 | 126 | 193 | 241 | 241 | 139.7 |
...
|---|---:|---:|
| Activations | 48 | 144 |
| Activations/second | 688.5 | 1052.2 |
| Maximum active leases | 2 | 2 |
| Maximum queue depth | 0 | 4 |
| Acquire-wait P95 (us) | 10 | 2628 |
| Queued acquire-wait P95 (us) | n/a | 3026 |
...
| timeout_and_cancellation_overshoot_are_bounded | PASS | each overshoot <= 500000 microseconds | timeout_max=1061us, cancellation_max=4534us |
...
| rss_has_no_unbounded_monotonic_growth | PASS | steady-state range and net growth <= 67108864 bytes | samples=343, min=17182720, max=17428480, range=245760, first=17182720, last=17428480, net_growth=245760, monotonic_non_decreasing=true, allowance=67108864 |
