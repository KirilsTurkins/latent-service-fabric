...
**Generated:** Unix epoch 1787816359456 ms
**Raw results:** `/home/slirik/IdeaProjects/latent-service-fabric/benchmarks/phase0/calibration/native-linux-2026-08-27/runs/run-03/raw-results.json`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Process launch to completion | 12 | 50679 | 51762 | 58883 | 58883 | 58883 | 52338.1 |
| Cold activation inside issue-23 harness | 12 | 203 | 214 | 232 | 232 | 232 | 216.7 |
...
| Metric | Microseconds |
|---|---:|
| External process launch to runtime/pool ready | 3944 |
| Rust entry to observed worker/pool readiness | 2777 |
| Capsule validation and component load | 83 |
| Wasmtime engine/backend construction | 176 |
| Component preparation | 47892 |
| Rust entry to retained invocation readiness | 53656 |
| Prepared-component release | 72 |
...
| Metric | N | Min | P50 | P95 | P99 | Max | Mean |
|---|---:|---:|---:|---:|---:|---:|---:|
| acquire_or_queue_wait_micros | 343 | 1 | 4 | 2473 | 3024 | 3879 | 543.4 |
| activation_resource_reclamation_micros | 343 | 16 | 24 | 53 | 146 | 179 | 30.3 |
| backend_resource_cleanup_micros | 343 | 23 | 35 | 71 | 176 | 392 | 42.7 |
| backend_setup_micros | 343 | 33 | 64 | 116 | 153 | 421 | 70.2 |
| backend_total_micros | 343 | 85 | 1165 | 7220 | 25667 | 26093 | 1764.4 |
| cancellation_elapsed_micros | 10 | 6379 | 7362 | 8292 | 8292 | 8292 | 7342.1 |
| cancellation_overshoot_micros | 10 | 1379 | 2362 | 3292 | 3292 | 3292 | 2342.1 |
| cell_disposition_micros | 343 | 1 | 3 | 7 | 9 | 10 | 3.3 |
| cold_echo_elapsed_micros | 12 | 203 | 214 | 232 | 232 | 232 | 216.7 |
| component_post_return_micros | 343 | 0 | 0 | 2 | 3 | 3 | 0.5 |
| contained_execution_micros | 343 | 62 | 1133 | 7179 | 25612 | 26040 | 1721.7 |
| domain_error_elapsed_micros | 10 | 102 | 115 | 222 | 222 | 222 | 142.3 |
| guest_call_micros | 343 | 26 | 1079 | 7137 | 25527 | 25964 | 1657.4 |
| host_call_micros | 343 | 0 | 1 | 1 | 2 | 3 | 0.6 |
| memory_pressure_elapsed_micros | 10 | 2190 | 2208 | 2430 | 2430 | 2430 | 2264.6 |
| outcome_classification_micros | 343 | 0 | 0 | 0 | 1 | 2 | 0.1 |
| post_invocation_cleanup_micros | 343 | 18 | 27 | 62 | 152 | 187 | 34.2 |
| process_launch_to_completion_real_executable_micros | 12 | 50679 | 51762 | 58883 | 58883 | 58883 | 52338.1 |
| recovery_after_cancellation_elapsed_micros | 10 | 122 | 150 | 249 | 249 | 249 | 164.2 |
| recovery_after_domain_error_elapsed_micros | 10 | 104 | 118 | 198 | 198 | 198 | 138.7 |
| recovery_after_memory_pressure_elapsed_micros | 10 | 144 | 153 | 190 | 190 | 190 | 160.4 |
| recovery_after_timeout_elapsed_micros | 10 | 146 | 156 | 229 | 229 | 229 | 171.8 |
| recovery_after_trap_elapsed_micros | 10 | 104 | 123 | 237 | 237 | 237 | 151.7 |
| retained_first_echo_elapsed_micros | 1 | 251 | 251 | 251 | 251 | 251 | 251.0 |
| reusable_proof_micros | 343 | 0 | 0 | 0 | 1 | 1 | 0.0 |
| throughput_at_capacity_elapsed_micros | 48 | 1127 | 1257 | 1844 | 2377 | 2377 | 1334.7 |
| throughput_bounded_queue_saturation_elapsed_micros | 144 | 1154 | 2435 | 3884 | 5422 | 5514 | 2547.8 |
| timeout_elapsed_micros | 10 | 25128 | 25551 | 26129 | 26129 | 26129 | 25594.8 |
| timeout_overshoot_micros | 10 | 128 | 551 | 1129 | 1129 | 1129 | 594.8 |
| total_invocation_micros | 343 | 100 | 1261 | 7242 | 25710 | 26129 | 2336.2 |
| trap_elapsed_micros | 10 | 109 | 119 | 229 | 229 | 229 | 149.4 |
| warm_echo_elapsed_micros | 40 | 100 | 120 | 222 | 235 | 235 | 146.1 |
...
|---|---:|---:|
| Activations | 48 | 144 |
| Activations/second | 637.3 | 1085.1 |
| Maximum active leases | 2 | 2 |
| Maximum queue depth | 0 | 4 |
| Acquire-wait P95 (us) | 12 | 2596 |
| Queued acquire-wait P95 (us) | n/a | 2985 |
...
| timeout_and_cancellation_overshoot_are_bounded | PASS | each overshoot <= 500000 microseconds | timeout_max=1129us, cancellation_max=3292us |
...
| rss_has_no_unbounded_monotonic_growth | PASS | steady-state range and net growth <= 67108864 bytes | samples=343, min=17498112, max=17747968, range=249856, first=17498112, last=17747968, net_growth=249856, monotonic_non_decreasing=true, allowance=67108864 |
