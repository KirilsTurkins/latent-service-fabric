...
**Generated:** Unix epoch 1788015250623 ms
**Raw results:** `/home/slirik/phase0-native-work.sG8UOx/final-checkout-gatefix/target/phase0-gate/full.IC8i9Z/baseline/raw-results.json`
...
| Repository commit | 54d02679aff757d4bf25d16e088b32d45682cb7f |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Process launch to completion | 12 | 52115 | 52638 | 54238 | 54238 | 54238 | 52782.2 |
| Cold activation inside issue-23 harness | 12 | 202 | 222 | 320 | 320 | 320 | 229.8 |
...
| Metric | Microseconds |
|---|---:|
| External process launch to runtime/pool ready | 3997 |
| Rust entry to observed worker/pool readiness | 2775 |
| Capsule validation and component load | 79 |
| Wasmtime engine/backend construction | 184 |
| Component preparation | 49520 |
| Rust entry to retained invocation readiness | 55438 |
| Prepared-component release | 87 |
...
|---|---:|
| Cache enabled | true |
| First preparation (microseconds) | 49520 |
...
| Metric | N | Min | P50 | P95 | P99 | Max | Mean |
|---|---:|---:|---:|---:|---:|---:|---:|
| acquire_or_queue_wait_micros | 343 | 1 | 4 | 2515 | 3095 | 3690 | 549.1 |
| activation_resource_reclamation_micros | 343 | 16 | 24 | 61 | 168 | 223 | 31.9 |
| backend_resource_cleanup_micros | 343 | 23 | 36 | 79 | 184 | 240 | 43.4 |
| backend_setup_micros | 343 | 34 | 71 | 117 | 218 | 383 | 75.2 |
| backend_total_micros | 343 | 85 | 1184 | 7242 | 25811 | 25937 | 1781.4 |
| cancellation_elapsed_micros | 10 | 6343 | 7309 | 8309 | 8309 | 8309 | 7306.8 |
| cancellation_overshoot_micros | 10 | 1343 | 2309 | 3309 | 3309 | 3309 | 2306.8 |
| cell_disposition_micros | 343 | 1 | 3 | 7 | 10 | 12 | 3.5 |
| cold_echo_elapsed_micros | 12 | 202 | 222 | 320 | 320 | 320 | 229.8 |
| component_post_return_micros | 343 | 0 | 0 | 2 | 3 | 6 | 0.5 |
| contained_execution_micros | 343 | 62 | 1146 | 7180 | 25748 | 25880 | 1738.0 |
| domain_error_elapsed_micros | 10 | 100 | 156 | 200 | 200 | 200 | 154.7 |
| guest_call_micros | 343 | 26 | 1091 | 7133 | 25666 | 25840 | 1667.5 |
| host_call_micros | 343 | 0 | 1 | 2 | 3 | 4 | 0.7 |
| memory_pressure_elapsed_micros | 10 | 2226 | 2307 | 2457 | 2457 | 2457 | 2329.6 |
| outcome_classification_micros | 343 | 0 | 0 | 1 | 1 | 2 | 0.1 |
| post_invocation_cleanup_micros | 343 | 18 | 28 | 69 | 175 | 228 | 36.1 |
| process_launch_to_completion_real_executable_micros | 12 | 52115 | 52638 | 54238 | 54238 | 54238 | 52782.2 |
| recovery_after_cancellation_elapsed_micros | 10 | 143 | 190 | 211 | 211 | 211 | 178.7 |
| recovery_after_domain_error_elapsed_micros | 10 | 100 | 178 | 229 | 229 | 229 | 175.0 |
| recovery_after_memory_pressure_elapsed_micros | 10 | 149 | 164 | 229 | 229 | 229 | 175.7 |
| recovery_after_timeout_elapsed_micros | 10 | 145 | 163 | 204 | 204 | 204 | 167.6 |
| recovery_after_trap_elapsed_micros | 10 | 104 | 143 | 197 | 197 | 197 | 150.1 |
| retained_first_echo_elapsed_micros | 1 | 240 | 240 | 240 | 240 | 240 | 240.0 |
| reusable_proof_micros | 343 | 0 | 0 | 0 | 1 | 13 | 0.1 |
| throughput_at_capacity_elapsed_micros | 48 | 1185 | 1261 | 1968 | 2062 | 2062 | 1376.1 |
| throughput_bounded_queue_saturation_elapsed_micros | 144 | 1226 | 2477 | 3952 | 4907 | 5020 | 2571.2 |
| timeout_elapsed_micros | 10 | 25208 | 25632 | 25987 | 25987 | 25987 | 25641.1 |
| timeout_overshoot_micros | 10 | 208 | 632 | 987 | 987 | 987 | 641.1 |
| total_invocation_micros | 343 | 100 | 1284 | 7267 | 25857 | 25987 | 2359.8 |
| trap_elapsed_micros | 10 | 115 | 176 | 258 | 258 | 258 | 186.2 |
| warm_echo_elapsed_micros | 40 | 102 | 154 | 242 | 251 | 251 | 166.6 |
...
|---|---:|---:|
| Activations | 48 | 144 |
| Activations/second | 654.9 | 1074.8 |
| Maximum active leases | 2 | 2 |
| Maximum queue depth | 0 | 4 |
| Acquire-wait P95 (us) | 8 | 2623 |
| Queued acquire-wait P95 (us) | n/a | 2945 |
...
| prepared_cache_reuse_probe_matches_configuration | PASS | enabled cache has a direct same-key handle hit; disabled control has no reusable cache entry | enabled=true, status=cache_hit, first_prepare_micros=49520, second_prepare_micros=Some(22), same_handle=Some(true), entries=1 |
...
| timeout_and_cancellation_overshoot_are_bounded | PASS | each overshoot <= 500000 microseconds | timeout_max=987us, cancellation_max=3309us |
...
| rss_has_no_unbounded_monotonic_growth | PASS | steady-state range and net growth <= 67108864 bytes | samples=343, min=17846272, max=18075648, range=229376, first=17846272, last=18075648, net_growth=229376, monotonic_non_decreasing=true, allowance=67108864 |
