...
Authorities: [WIT values](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/protocol/wit-values.md), [release compatibility](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/release-compatibility.md), [management services](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/management-services.md), [SDK guide](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/sdk/README.md).
