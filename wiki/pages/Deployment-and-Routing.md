...
Authorities: [deployment/routing](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/deployment-routing.md), [operator operations](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-operator-workflows.md), [rollouts](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-rollouts.md), [canary promotion](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-canary-promotion.md), [rollback](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-rollback.md).
