...
For disclosure and supported boundaries, follow [SECURITY](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/SECURITY.md). Authorities: [publisher trust](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/publisher-trust.md), [admission](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/package-admission.md), [provenance](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/build-provenance.md), [trusted AOT](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/runtime/trusted-aot.md).
