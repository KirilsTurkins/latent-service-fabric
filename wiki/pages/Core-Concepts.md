...
Authorities: [package format](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/protocol/package-format.md), [package admission](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/package-admission.md), [release lifecycle](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/release-lifecycle.md), [operator workflows](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-operator-workflows.md).
