...
Authorities: [invocation protocol](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/protocol/invocation-service.md), [resource budgets](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/runtime/resource-budgets.md), [canary observation](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-canary-observation.md), [release lifecycle](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/release-lifecycle.md).
