...
**Phase 2 is complete; the [completion report](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-completion.md) records the gate decision, exact evidence and qualifications.** Packaging, signed admission, lifecycle controls, protected native reuse, durable audit, rollouts, canary promotion, rollback and operator workflows extend the completed Phase 1 baseline. Phase 3 has **41 planned tickets** under [epic #201](https://github.com/KirilsTurkins/latent-service-fabric/issues/201); those capabilities are not current runtime promises.
...
The latest published prerelease is [0.1.0-alpha.3](https://github.com/KirilsTurkins/latent-service-fabric/releases/tag/0.1.0-alpha.3), delivering the completed Phase 2 surface. Current product references use [release](https://github.com/KirilsTurkins/latent-service-fabric/tree/release); contributor work continues on development. Phase completion, product release and Wiki publication retain separate receipts. This remains an alpha prerelease, with the finite evidence and limitations stated above. Start with the [operator workflow guide](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/phase-2-operator-workflows.md) and [architecture](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/ARCHITECTURE.md).
