...
Authorities: [creating a capsule](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/component-development/creating-a-capsule.md), [packaging](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/component-development/packaging.md), [SBOM](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/component-development/sbom.md), [build provenance](https://github.com/KirilsTurkins/latent-service-fabric/blob/release/docs/reference/build-provenance.md).
