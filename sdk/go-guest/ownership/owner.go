...
func (o Owner[T]) Borrow() (T, func()) {
	if o.cell == nil || !o.cell.state.CompareAndSwap(0, 1) {
		panic("lsf: owner busy or consumed")
	}
...
func (o Owner[T]) Take() T {
	if o.cell == nil || !o.cell.state.CompareAndSwap(0, 2) {
		panic("lsf: owner busy or consumed")
	}
	value := o.cell.value
	var empty T
...
func (o Owner[T]) Close(drop func(T)) {
	if o.cell == nil {
		panic("lsf: zero owner")
	}
	if o.cell.state.Load() == 2 {
		return
	}
	drop(o.Take())
}
