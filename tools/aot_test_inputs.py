...
PROFILE = "debug-all-features-v4"
# Exact --all-features closure, including the explicit guest-clock test seam.
# Production Wasm exceptions remain an explicit, bounded Java profile opt-in.
FEATURES = ("aot-test-timings", "development-clock-fixture", "development-test-host", "java-guest-diagnostic")
