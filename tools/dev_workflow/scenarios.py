...
NODE_ONLY = {"authentication", "deployment", "restart", "pressure", "compiler-isolation", "protected-files", "native-cache", "running-cancellation", "immutable-blob-fixture", "scoped-secret-fixture"}
