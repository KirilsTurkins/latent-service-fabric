// Bounded public inventory projection, matching the maintained CLI DTO.
use latent_wire::management::{node_inventory_from_proto, node_inventory_to_proto, proto};
use serde_json::{json, Value};

fn invalid_response() -> &'static str {
    "session-invalid-inventory"
}

pub(super) fn project(value: proto::NodeInventory) -> Result<Value, &'static str> {
...
fn topology_entry(value: &proto::NodeTopologyEntry) -> Result<Value, &'static str> {
...
fn quotas(value: proto::NodeQuotaSummary) -> Result<Value, &'static str> {
