...
def main():
    ...
    parser.add_argument("--experiment", choices=("warm", "cold", "cache", "budget", "recovery", "ownership"), default="warm",
                        help="cold #101; cache #102; budget #103; recovery #119; ownership #104 direct/profiled calls")
