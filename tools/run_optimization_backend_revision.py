...
def main():
    ...
    parser.add_argument("--experiment", choices=("warm", "cold", "cache", "budget", "recovery", "ownership", "codec", "engine", "catalog", "catalog-mutations"), default="warm",
                        help="cold #101; cache #102; budget #103; recovery #119; ownership #104 direct/profiled calls; codec #105 no-guest batches; engine #106 allocator/compiler matrix; catalog #107 dormant catalogs; catalog-mutations #108 single mutations/reopen")
