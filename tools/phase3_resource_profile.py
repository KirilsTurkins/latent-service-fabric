...
PROFILES = {
    ...
    "web-smoke": {"id": "phase3-resource-web-smoke-v2", "kind": "web", "dormantSteps": [2, 4], "cells": 1,
                  "controlJobs": 2, "maximumPreparationSamples": 64, "preparationSampleIntervalMillis": 1000,
                  "samplesPerPhase": 3, "cycles": 2, "arrivalsPerCycle": 4,
                  "arrivalIntervalMillis": 10, "maximumOutstanding": 5, "deadlineSeconds": 600},
    "web-campaign": {"id": "phase3-resource-web-manual-v2", "kind": "web", "dormantSteps": [2, 4, 8], "cells": 2,
                     "controlJobs": 2, "maximumPreparationSamples": 64, "preparationSampleIntervalMillis": 1000,
